...
readJson = fileutils_1.readJsonFile // making this an arg allows us to reuse in devkit
    ...
    for (const file of projectFiles) {
        ...
        if (fileName === 'package.json') {
            ...
            if (packageJson && packageJson.nx && packageJson.nx.ignore)
                continue;
            const _a = buildProjectConfigurationFromPackageJson(file, packageJson, nxJson), { name } = _a, config = (0, tslib_1.__rest)(_a, ["name"]);
            if (!projects[name]) {
