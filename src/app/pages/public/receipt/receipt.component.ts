...
export class ReceiptComponent implements OnInit {
  ...
  async getSetItemById(_id){
    ...
    let r = await this.apiService.callapi(this.apiService.APIS.PUBLIC_TRANSACTION_LIST,{_id:_id}).toPromise();
    console.log('item fetched');
    this.item=r.data[0];
    this.bank = this.item.bankstatement;
